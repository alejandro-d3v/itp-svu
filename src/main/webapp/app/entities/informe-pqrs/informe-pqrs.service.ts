...
export default class InformePqrsService {
  ...
  public create(entity: IInformePqrs): Promise<IInformePqrs> {
    return new Promise<IInformePqrs>((resolve, reject) => {
      axios
  ...
  public update(entity: IInformePqrs): Promise<IInformePqrs> {
    return new Promise<IInformePqrs>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IInformePqrs): Promise<IInformePqrs> {
    return new Promise<IInformePqrs>((resolve, reject) => {
      axios
