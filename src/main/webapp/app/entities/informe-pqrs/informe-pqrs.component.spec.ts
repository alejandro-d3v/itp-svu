...
describe('Component Tests', () => {
  ...
  describe('InformePqrs Management Component', () => {
    ...
    beforeEach(() => {
      ...
      informePqrsServiceStub.retrieve.resolves({ headers: {} });
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        // GIVEN
        informePqrsServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 'ABC' }] });
    ...
    describe('Handles', () => {
      ...
      beforeEach(async () => {
        ...
        comp = wrapper.vm;
        await comp.$nextTick();
        informePqrsServiceStub.retrieve.reset();
        informePqrsServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should re-initialize the page', async () => {
        ...
        expect(informePqrsServiceStub.retrieve.callCount).toEqual(1);
        expect(comp.informePqrs[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
      });
      ...
      it('Should call delete service on confirmDelete', async () => {
        ...
        // THEN
        expect(informePqrsServiceStub.delete.called).toBeTruthy();
